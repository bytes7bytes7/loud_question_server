...
import 'package:load_question_server/src/features/common/application/services/hash_service.dart'
    as _i18;
import 'package:load_question_server/src/features/common/common.dart' as _i100;
...
import 'package:mapster/mapster.dart' as _i56;
import 'package:mediator/mediator.dart' as _i57;
...
_i1.GetIt init(
  ...
  gh.singleton<_i25.JsonConverter<_i26.RegisterRequest, Map<String, Object?>>>(
      _i27.RegisterRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i26.LogOutRequest, Map<String, Object?>>>(
      _i28.LogOutRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i26.LogInRequest, Map<String, Object?>>>(
  ...
  gh.singleton<
          _i21.JsonConverter<_i33.StartAnswerRequest, Map<String, Object?>>>(
      _i34.StartAnswerRequestJsonConverter());
  gh.singleton<
          _i21.JsonConverter<_i26.VerifyTokenRequest, Map<String, Object?>>>(
      _i35.VerifyTokenRequestJsonConverter());
  gh.singleton<
          _i21.JsonConverter<_i22.CreateLobbyRequest, Map<String, Object?>>>(
      _i36.CreateLobbyRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i33.GetAnswerRequest, Map<String, Object?>>>(
      _i37.GetAnswerRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i33.GetStateRequest, Map<String, Object?>>>(
      _i38.GetStateRequestJsonConverter());
  gh.singleton<
          _i21.JsonConverter<_i33.GiveAnswerRequest, Map<String, Object?>>>(
      _i39.GiveAnswerRequestJsonConverter());
  gh.singleton<
          _i21.JsonConverter<_i33.ListenStateRequest, Map<String, Object?>>>(
      _i40.ListenStateRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i33.RestartRequest, Map<String, Object?>>>(
      _i41.RestartRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i33.SetLeaderRequest, Map<String, Object?>>>(
      _i42.SetLeaderRequestJsonConverter());
  gh.singleton<
          _i21.JsonConverter<_i33.SetNotReadyRequest, Map<String, Object?>>>(
      _i43.SetNotReadyRequestJsonConverter());
  gh.singleton<_i21.JsonConverter<_i33.SetReadyRequest, Map<String, Object?>>>(
      _i44.SetReadyRequestJsonConverter());
  gh.singleton<
          _i21.JsonConverter<_i33.StartRoundRequest, Map<String, Object?>>>(
      _i45.StartRoundRequestJsonConverter());
  ...
  gh.singleton<_i49.ListenStateQueryValidator>(
      _i49.ListenStateQueryValidator());
  gh.singleton<_i50.LobbyPasswordHashRepository>(
    _i51.TestLobbyPasswordHashRepository(),
    registerFor: {_test},
  );
  gh.singleton<_i52.LobbyRepository>(
    _i53.TestLobbyRepository(dateTimeRepository: gh<_i6.DateTimeRepository>()),
    registerFor: {_test},
  );
  gh.singleton<_i54.LogInQueryValidator>(_i54.LogInQueryValidator());
  gh.singleton<_i55.LogOutCommandValidator>(_i55.LogOutCommandValidator());
  gh.singleton<_i56.Mapster>(mapsterModule.mapster);
  gh.singleton<_i57.Mediator>(mediatorModule.mediator);
  gh.singleton<_i11.PasswordHashRepository>(
    _i58.TestPasswordHashRepository(),
    registerFor: {_test},
  );
  gh.singleton<_i59.QuestionRepository>(
    _i60.TestQuestionRepository(),
    registerFor: {_test},
  );
  gh.singleton<_i61.RegisterCommandValidator>(_i61.RegisterCommandValidator());
  gh.singleton<_i62.RestartCommandValidator>(_i62.RestartCommandValidator());
  gh.singleton<_i63.SetLeaderCommandValidator>(
      _i63.SetLeaderCommandValidator());
  gh.singleton<_i64.SetNotReadyCommandValidator>(
      _i64.SetNotReadyCommandValidator());
  gh.singleton<_i65.SetReadyCommandValidator>(_i65.SetReadyCommandValidator());
  gh.singleton<_i66.StartAnswerCommandValidator>(
      _i66.StartAnswerCommandValidator());
  gh.singleton<_i67.StartRoundCommandValidator>(
      _i67.StartRoundCommandValidator());
  gh.singleton<_i11.TokenRepository>(
    _i68.TestTokenRepository(),
    registerFor: {_test},
  );
  gh.factory<_i69.UserController>(() => _i69.UserController(
        mediator: gh<_i57.Mediator>(),
        mapster: gh<_i56.Mapster>(),
      ));
  gh.singleton<_i70.UserGameStateActivityRepository>(
    _i71.TestUserGameStateActivityRepository(),
    registerFor: {_test},
  );
  gh.singleton<_i72.UserMapsterRegistrar>(
      _i72.UserMapsterRegistrar(gh<_i56.Mapster>())..register());
  gh.singleton<_i73.UserMediatorRegistrar>(
      _i73.UserMediatorRegistrar(gh<_i57.Mediator>())..register());
  gh.singleton<_i11.UserRepository>(
    _i74.TestUserRepository(),
    registerFor: {_test},
  );
  gh.singleton<_i75.VerifyTokenQueryHandler>(_i75.VerifyTokenQueryHandler(
    jwtTokenService: gh<_i76.JwtTokenService>(),
    tokenRepository: gh<_i11.TokenRepository>(),
  ));
  gh.singleton<_i77.VerifyTokenQueryValidator>(
      _i77.VerifyTokenQueryValidator());
  gh.factory<_i78.AuthController>(() => _i78.AuthController(
        mediator: gh<_i57.Mediator>(),
        mapster: gh<_i56.Mapster>(),
      ));
  gh.singleton<_i79.AuthMapsterRegistrar>(
      _i79.AuthMapsterRegistrar(gh<_i56.Mapster>())..register());
  gh.singleton<_i80.AuthMediatorRegistrar>(
      _i80.AuthMediatorRegistrar(gh<_i57.Mediator>())..register());
  gh.singleton<_i81.CreateLobbyCommandHandler>(_i81.CreateLobbyCommandHandler(
  ...
  gh.factory<_i82.GameController>(() => _i82.GameController(
        mediator: gh<_i57.Mediator>(),
        mapster: gh<_i56.Mapster>(),
      ));
  gh.singleton<_i83.GameMapsterRegistrar>(
      _i83.GameMapsterRegistrar(gh<_i56.Mapster>())..register());
  gh.singleton<_i84.GameMediatorRegistrar>(
      _i84.GameMediatorRegistrar(gh<_i57.Mediator>())..register());
  gh.singleton<_i85.GetAnswerCommandHandler>(_i85.GetAnswerCommandHandler(
    lobbyRepository: gh<_i11.LobbyRepository>(),
    gameStateService: gh<_i86.GameStateService>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
    mapster: gh<_i56.Mapster>(),
  ));
  gh.singleton<_i87.GetLobbiesQueryHandler>(
      _i87.GetLobbiesQueryHandler(lobbyRepository: gh<_i11.LobbyRepository>()));
  gh.singleton<_i88.GetLobbyQueryHandler>(
      _i88.GetLobbyQueryHandler(lobbyRepository: gh<_i11.LobbyRepository>()));
  gh.singleton<_i89.GetStateQueryHandler>(_i89.GetStateQueryHandler(
    lobbyRepository: gh<_i11.LobbyRepository>(),
    gameStateService: gh<_i86.GameStateService>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
  ...
  gh.singleton<_i90.GetUserQueryHandler>(
      _i90.GetUserQueryHandler(userRepository: gh<_i11.UserRepository>()));
  gh.singleton<_i91.GiveAnswerCommandHandler>(_i91.GiveAnswerCommandHandler(
    lobbyRepository: gh<_i11.LobbyRepository>(),
    gameStateService: gh<_i86.GameStateService>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
  ...
  gh.singleton<_i92.JoinLobbyCommandHandler>(_i92.JoinLobbyCommandHandler(
    lobbyRepository: gh<_i11.LobbyRepository>(),
    lobbyPasswordHashRepository: gh<_i11.LobbyPasswordHashRepository>(),
    hashService: gh<_i18.HashService>(),
  ));
  gh.singleton<_i93.ListenStateQueryHandler>(_i93.ListenStateQueryHandler(
    gameStateService: gh<_i86.GameStateService>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
    mapster: gh<_i56.Mapster>(),
  ));
  gh.factory<_i94.LobbyController>(() => _i94.LobbyController(
        mediator: gh<_i57.Mediator>(),
        mapster: gh<_i56.Mapster>(),
      ));
  gh.singleton<_i95.LobbyMapsterRegistrar>(
      _i95.LobbyMapsterRegistrar(gh<_i56.Mapster>())..register());
  gh.singleton<_i96.LobbyMediatorRegistrar>(
      _i96.LobbyMediatorRegistrar(gh<_i57.Mediator>())..register());
  gh.singleton<_i97.LogInQueryHandler>(_i97.LogInQueryHandler(
    jwtTokenService: gh<_i76.JwtTokenService>(),
    hashService: gh<_i18.HashService>(),
  ...
  gh.singleton<_i98.LogOutCommandHandler>(_i98.LogOutCommandHandler(
    jwtTokenService: gh<_i76.JwtTokenService>(),
    tokenRepository: gh<_i11.TokenRepository>(),
  ));
  gh.singleton<_i99.RegisterCommandHandler>(_i99.RegisterCommandHandler(
    jwtTokenService: gh<_i76.JwtTokenService>(),
    hashService: gh<_i100.HashService>(),
    userRepository: gh<_i11.UserRepository>(),
    passwordHashRepository: gh<_i11.PasswordHashRepository>(),
    tokenRepository: gh<_i11.TokenRepository>(),
  ));
  gh.singleton<_i101.RestartCommandHandler>(_i101.RestartCommandHandler(
    lobbyRepository: gh<_i11.LobbyRepository>(),
    gameStateService: gh<_i86.GameStateService>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
  ...
  gh.singleton<_i102.SetLeaderCommandHandler>(_i102.SetLeaderCommandHandler(
    lobbyRepository: gh<_i11.LobbyRepository>(),
    gameStateService: gh<_i86.GameStateService>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
  ...
  gh.singleton<_i103.SetNotReadyCommandHandler>(_i103.SetNotReadyCommandHandler(
    gameStateService: gh<_i86.GameStateService>(),
    lobbyRepository: gh<_i11.LobbyRepository>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
  ...
  gh.singleton<_i104.SetReadyCommandHandler>(_i104.SetReadyCommandHandler(
    gameStateService: gh<_i86.GameStateService>(),
    lobbyRepository: gh<_i11.LobbyRepository>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
  ...
  gh.singleton<_i105.StartAnswerCommandHandler>(_i105.StartAnswerCommandHandler(
    gameStateService: gh<_i86.GameStateService>(),
    lobbyRepository: gh<_i11.LobbyRepository>(),
    dateTimeRepository: gh<_i11.DateTimeRepository>(),
    userGameStateActivityRepository: gh<_i11.UserGameStateActivityRepository>(),
  ...
  gh.singleton<_i106.StartRoundCommandHandler>(_i106.StartRoundCommandHandler(
    gameStateService: gh<_i86.GameStateService>(),
    lobbyRepository: gh<_i11.LobbyRepository>(),
